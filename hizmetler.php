...
<section class="page-head">
  <div class="container">
    ...
    <nav><ol class="breadcrumb"><li class="breadcrumb-item"><a href="<?= SITE_URL ?>/">Anasayfa</a></li><li class="breadcrumb-item active">Çalışma Alanları</li></ol></nav>
  </div>
</section>
...
<section>
  <div class="container">
    <div class="section-head center">
      ...
      <p>Ceza, aile, ticaret, iş, gayrimenkul ve icra hukuku alanlarında deneyimli kadromuzla yanınızdayız.</p>
    </div>
    <div class="row g-4">
...
<section class="cta">
  <div class="container d-flex justify-content-between align-items-center flex-wrap">
    <h3>Hukuki sorununuz için bize ulaşın</h3>
