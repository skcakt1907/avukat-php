...
if($_SERVER['REQUEST_METHOD']==='POST'){
    ...
    if(!$f['ad'] || !$f['tel'] || !$f['hizmet']){
        ...
        $stmt->execute($f);
        $mesaj = 'Randevu talebiniz alındı. Büromuz en kısa sürede sizinle iletişime geçecek.';
    }
}
...
<section>
  <div class="container">
    <div class="row g-5">
      <div class="col-lg-7">
        <span class="badge-mini">Ön Görüşme</span>
        <h2>Hukuki Sorununuz İçin <span style="color:var(--primary)">Randevu</span> Alın</h2>
        <p class="text-muted mb-4">Formu doldurun, büromuz sizi arasın. Durumunuzu değerlendirip izlenecek hukuki yol haritasını birlikte belirleyelim. Tüm bilgileriniz gizli tutulur.</p>
        ...
        <form method="post" class="contact-form">
          ...
          <h5 class="mb-3 mt-4" style="color:var(--primary)"><i class="bi bi-clipboard-check me-2"></i>Dosya Detayları</h5>
          <div class="row g-3">
            <div class="col-md-6">
            ...
            <div class="col-md-4"><label class="form-label">Dosya / Esas No (varsa)</label><input class="form-control" name="alan" placeholder="varsa"></div>
            <div class="col-md-4">
              <label class="form-label">Dosya Durumu</label>
              <select class="form-select" name="butce">
                <option value="">— Seçiniz —</option>
                <option>Henüz dava açılmadı</option>
                <option>Dava devam ediyor</option>
                <option>İcra aşamasında</option>
                <option>Sadece danışmanlık</option>
            ...
            <div class="col-md-4">
              ...
              <select class="form-select" name="baslangic">
                <option value="">— Seçiniz —</option>
                <option>Acil (süre/duruşma yakın)</option>
                <option>1 hafta içinde</option>
                <option>1 ay içinde</option>
                <option>Sadece bilgi alıyorum</option>
              </select>
            </div>
            <div class="col-12"><label class="form-label">Konunuzu Kısaca Anlatın</label><textarea class="form-control" name="detay" rows="5" placeholder="Hukuki durumunuzu kısaca özetleyin..."></textarea></div>
      ...
      <div class="col-lg-5">
        ...
        <ul class="quote-perks">
          <li><i class="bi bi-chat-left-text"></i><div><strong>İlk Görüşme</strong><span>Durumunuzu değerlendiriyoruz.</span></div></li>
          <li><i class="bi bi-clock-history"></i><div><strong>24 Saatte Dönüş</strong><span>En geç 1 iş gününde.</span></div></li>
          <li><i class="bi bi-shield-lock"></i><div><strong>Tam Gizlilik</strong><span>Bilgileriniz korunur.</span></div></li>
        </ul>
      </div>
    </div>
  </div>
