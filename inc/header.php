    ...
    <div class="collapse navbar-collapse" id="nav">
      <ul class="navbar-nav ms-auto">
        ...
        <li class="nav-item nav-dropdown">
          <a class="nav-link <?= in_array($current,['hizmetler.php','hizmet-detay.php'])?'active':'' ?>" href="<?= SITE_URL ?>/hizmetler">Çalışma Alanları <i class="bi bi-chevron-down ms-1" style="font-size:.7rem"></i></a>
        ...
        <li class="nav-item"><a class="nav-link <?= in_array($current,['blog.php','blog-detay.php'])?'active':'' ?>" href="<?= SITE_URL ?>/blog">Makaleler</a></li>
